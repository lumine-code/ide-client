  ...
  async preflightWorkspaceEdit(documentChanges, session) {
    ...
    for (const change of documentChanges) {
      if (change.kind === "create") {
        ...
        steps.push({ kind: "create", change, target, skip });
        continue;
      }
      if (change.kind === "rename") {
        ...
        steps.push({ kind: "rename", change, source, target, targetExists, skip });
        continue;
      }
      if (change.kind === "delete") {
        ...
        steps.push({ kind: "delete", change, target, skip });
        continue;
      }
      ...
      steps.push({ kind: "text", change, editor });
    }
