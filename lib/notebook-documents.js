...
class NotebookRecord {
  constructor(manager, { filePath, notebookType, metadata, show }) {
    ...
    // Adapters that ever opened this notebook. Sticky for the record's
    // lifetime so a consumer's stand-down decision does not flap while a
    // server restarts.
...
module.exports = class NotebookDocuments {
  ...
  // the path, which is also the answer when ide-jupyter is not installed.
